...
> - Skala severity ketiga (setelah Trail of Bits dan ConsenSys di [[W08 - Smart Contract Auditing]]): **Code4rena** — QA, Med (2), High (3).
...
Selain OWASP dan Trail of Bits (dibahas di [[W08 - Smart Contract Auditing]]), **Code4rena**, sebuah platform keamanan smart contract, menerapkan tingkat severity berikut untuk program mereka:
...
- Boleh pakai tool apa pun yang kamu punya (lihat Slither/Mythril/Echidna di [[W08 - Smart Contract Auditing]])
